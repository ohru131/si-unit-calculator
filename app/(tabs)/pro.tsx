...
const EN_COPY = {
  ...
  features: [
    ...
    ["Notebook PDF export", "Share any calculation notebook as a formatted PDF"],
  ],
...
const COPY: Record<AppLanguage, typeof EN_COPY> = {
  ...
  ja: {
    ...
    features: [
      ...
      ["計算ノートのPDFエクスポート", "計算ノートを整形されたPDFとして共有"],
    ],
  ...
  es: {
    ...
    features: [
      ...
      ["Exportar cuadernos a PDF", "Comparte cualquier cuaderno de cálculo como PDF con formato"],
    ],
  ...
  "pt-BR": {
    ...
    features: [
      ...
      ["Exportação de cadernos em PDF", "Compartilhe qualquer caderno de cálculo como um PDF formatado"],
    ],
  ...
  de: {
    ...
    features: [
      ...
      ["Rechenheft-PDF-Export", "Teile jedes Rechenheft als formatiertes PDF"],
    ],
  ...
  fr: {
    ...
    features: [
      ...
      ["Export PDF des carnets", "Partagez n'importe quel carnet de calcul sous forme de PDF mis en forme"],
    ],
