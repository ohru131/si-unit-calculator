        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyCard}>
              <IconSymbol name="bookmark.fill" size={30} color={colors.primary} />
          ...
          <View style={styles.sheet}>
            ...
            <View style={styles.sheetHeader}>
              ...
              <Pressable accessibilityLabel="閉じる" onPress={closeEditor} style={({ pressed }) => [styles.closeButton, pressed && styles.iconPressed]}>
                <IconSymbol name="xmark" size={21} color={colors.muted} />
              </Pressable>
            </View>
...
const createStyles = (colors: ThemeColorPalette) => StyleSheet.create({
  ...
  title: { color: colors.foreground, fontSize: 30, fontWeight: "700", letterSpacing: -0.6 },
  ...
  constantCard: { alignItems: "center", backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 16, borderWidth: 1, flexDirection: "row", minHeight: 76, paddingHorizontal: 13, paddingVertical: 12 },
  symbolBubble: { alignItems: "center", backgroundColor: colors.primarySurface, borderRadius: 10, height: 42, justifyContent: "center", width: 42 },
  symbol: { color: colors.primary, fontFamily: Platform.select({ ios: "Menlo", android: "monospace", default: "monospace" }), fontSize: 19, fontWeight: "700" },
  constantDetails: { flex: 1, marginLeft: 12 },
  expression: { color: colors.foreground, fontFamily: Platform.select({ ios: "Menlo", android: "monospace", default: "monospace" }), fontSize: 16, fontWeight: "600" },
  siValue: { color: colors.muted, fontFamily: Platform.select({ ios: "Menlo", android: "monospace", default: "monospace" }), fontSize: 12, marginTop: 4 },
  ...
  sheet: { backgroundColor: colors.surface, borderTopLeftRadius: 26, borderTopRightRadius: 26, paddingBottom: 36, paddingHorizontal: 22, paddingTop: 10 },
  sheetHandle: { alignSelf: "center", backgroundColor: colors.border, borderRadius: 3, height: 5, width: 42 },
  sheetHeader: { alignItems: "flex-start", flexDirection: "row", justifyContent: "space-between", paddingBottom: 20, paddingTop: 17 },
  sheetTitle: { color: colors.foreground, fontSize: 21, fontWeight: "700" },
  sheetDescription: { color: colors.muted, fontSize: 13, marginTop: 3 },
  closeButton: { alignItems: "center", backgroundColor: colors.surfaceSecondary, borderRadius: 18, height: 36, justifyContent: "center", width: 36 },
  fieldLabel: { color: colors.foreground, fontSize: 13, fontWeight: "700", marginBottom: 7, marginTop: 12 },
  input: { backgroundColor: colors.background, borderColor: colors.border, borderRadius: 12, borderWidth: 1, color: colors.foreground, fontFamily: Platform.select({ ios: "Menlo", android: "monospace", default: "monospace" }), fontSize: 18, minHeight: 50, paddingHorizontal: 14 },
  error: { color: colors.error, fontSize: 13, lineHeight: 19, marginTop: 11 },
  saveButton: { alignItems: "center", backgroundColor: colors.primaryFill, borderRadius: 13, marginTop: 22, minHeight: 52, justifyContent: "center" },
