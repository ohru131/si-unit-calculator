export type PresetNotebookCategory = { id: string; label: string; labelEn: string };

export type NotebookSeedConstant = { symbol: string; expression: string };
export type NotebookSeedStep = { title: string; titleEn: string; expression: string; targetUnit: string };
  ...
  "mechanics-of-materials": [
    {
      ...
      steps: [
        { title: "断面二次モーメント I", titleEn: "Second moment of area I", expression: "b*h^3/12", targetUnit: "mm^4" },
        { title: "断面係数 Z", titleEn: "Section modulus Z", expression: "b*h^2/6", targetUnit: "mm^3" },
      ],
    },
    {
      title: "曲げ応力（矩形断面の梁）",
      ...
      steps: [{ title: "曲げ応力 σ", titleEn: "Bending stress σ", expression: "M/Z", targetUnit: "MPa" }],
    },
    {
      ...
      steps: [{ title: "最大たわみ δ", titleEn: "Maximum deflection δ", expression: "5*w*L^4/(384*E*I)", targetUnit: "mm" }],
    },
    {
      ...
      steps: [{ title: "最大たわみ δ", titleEn: "Maximum deflection δ", expression: "P*L^3/(48*E*I)", targetUnit: "mm" }],
    },
    {
      title: "フックの法則（応力とひずみ）",
      ...
      localConstants: [
        { symbol: "E", expression: "205GPa" },
        { symbol: "epsilon", expression: "0.001" },
        { symbol: "sigma0", expression: "100MPa" },
      ],
      steps: [
        { title: "応力 σ = E×ε", titleEn: "Stress σ = E×ε", expression: "E*epsilon", targetUnit: "MPa" },
        { title: "ひずみ ε = σ/E", titleEn: "Strain ε = σ/E", expression: "sigma0/E", targetUnit: "" },
      ],
    },
    {
      title: "せん断応力",
      ...
      steps: [{ title: "せん断応力 τ", titleEn: "Shear stress τ", expression: "F/A", targetUnit: "MPa" }],
    },
    {
      title: "オイラー座屈荷重",
      ...
      steps: [{ title: "オイラー座屈荷重 Pcr", titleEn: "Euler buckling load Pcr", expression: "pi^2*E*I/(k*L)^2", targetUnit: "kN" }],
    },
  ],
};
