...
const UNIT_ERROR_MESSAGES: Record<AppLanguage, UnitErrorMessageCatalog> = {
  en: {
    ...
    invalidConstantDefinitionFormat: () => `Define a constant in the form "W1 = 3cm".`,
  ...
  ja: {
    ...
    invalidConstantDefinitionFormat: () => "定数は「W1 = 3cm」の形式で定義してください。",
  ...
  es: {
    ...
    invalidConstantDefinitionFormat: () => `Define una constante con el formato "W1 = 3cm".`,
  ...
  "pt-BR": {
    ...
    invalidConstantDefinitionFormat: () => `Defina uma constante no formato "W1 = 3cm".`,
  ...
  de: {
    ...
    invalidConstantDefinitionFormat: () => `Definiere eine Konstante im Format „W1 = 3cm“.`,
  ...
  fr: {
    ...
    invalidConstantDefinitionFormat: () => `Définissez une constante au format « W1 = 3cm ».`,
