...
const EN_COPY = {
  ...
  settingsSubtitle: "Language, units, and appearance.",
...
const COPY: Record<AppLanguage, Record<TranslationKey, string>> = {
  ...
  ja: {
    ...
    settings: "設定",
    settingsSubtitle: "言語・単位系・外観を設定します。",
    language: "アプリの言語",
    units: "優先する単位系",
    systemMetric: "メートル法",
    systemUS: "米国慣用単位",
  ...
  es: {
    ...
    settingsSubtitle: "Idioma, unidades y apariencia.",
  ...
  "pt-BR": {
    ...
    settingsSubtitle: "Idioma, unidades e aparência.",
  ...
  de: {
    ...
    settingsSubtitle: "Sprache, Einheiten und Erscheinungsbild.",
  ...
  fr: {
    ...
    settingsSubtitle: "Langue, unités et apparence.",
