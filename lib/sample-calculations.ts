...
export const SAMPLE_CALCULATIONS: SampleCalculation[] = [
  ...
  { id: "atan2-angle", category: "math", title: "2辺から角度を求める", titleEn: "Find an angle from two sides", description: "atan2で同じ次元の2辺から角度を出す", descriptionEn: "Use atan2 with two values of the same dimension", expression: "atan2(1m, 1m)", targetUnit: "deg" },
  { id: "logarithm", category: "math", title: "常用対数", titleEn: "Base-10 logarithm", description: "1000の常用対数を計算", descriptionEn: "Calculate the base-10 logarithm of 1000", expression: "log(1000)", targetUnit: "" },
