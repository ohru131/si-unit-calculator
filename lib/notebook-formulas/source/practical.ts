...
export const ELECTRICITY_BASICS_SEEDS: NotebookSeed[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: { en: "Apparent power S", ja: "皮相電力 S", es: "Potencia aparente S", "pt-BR": "Potência aparente S", de: "Scheinleistung S", fr: "Puissance apparente S" }, expression: "V*I", targetUnit: "W", formulaLatex: "S = VI" },
      { title: { en: "Real power P", ja: "有効電力 P", es: "Potencia activa P", "pt-BR": "Potência ativa P", de: "Wirkleistung P", fr: "Puissance active P" }, expression: "V*I*cos(φ)", targetUnit: "W", formulaLatex: "P = VI\\cos\\varphi" },
      { title: { en: "Reactive power Q", ja: "無効電力 Q", es: "Potencia reactiva Q", "pt-BR": "Potência reativa Q", de: "Blindleistung Q", fr: "Puissance réactive Q" }, expression: "V*I*sin(φ)", targetUnit: "W", formulaLatex: "Q = VI\\sin\\varphi" },
    ],
  },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: { en: "Line current I", ja: "線電流 I", es: "Corriente de línea I", "pt-BR": "Corrente de linha I", de: "Strom I", fr: "Courant de ligne I" }, expression: "P₂/(η*V*cos(φ))", targetUnit: "A", formulaLatex: "I = \\dfrac{P_2}{\\eta V \\cos\\varphi}" },
    ],
  },
];
