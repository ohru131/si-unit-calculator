...
| Pro screenshot | The Pro value proposition, history, CSV export, and personal unit set are all visible with high contrast. The 1179×2556px version retains legible English labels. | Include as the monetization and repeat-work screenshot. |
